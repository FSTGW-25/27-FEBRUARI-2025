...
<body>
  <div class="title-box">18 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 11.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seveneteen-Home.mp3');
    ...
    const fullMessage = `"Seperti pohon yang membutuhkan waktu untuk tumbuh, hidup juga membutuhkan kesabaran dan ketekunan 🤍. Tidak ada kesuksesan yang instan, semuanya melalui proses panjang yang kadang terasa sulit 🌼. Jika hari ini terasa berat, ingatlah bahwa akar yang kuat terbentuk dari ketahanan terhadap badai 🌈. Jangan menyerah, karena setiap kerja keras yang dilakukan hari ini akan menjadi fondasi bagi masa depan yang lebih baik 🌻. Teruslah tumbuh, teruslah berjuang 🍀."`;
